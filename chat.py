...
class OpenAIChat:
    ...
    def say(self, thing: str):
        ...
        user_message = {"role": "user", "content": thing}
        self.converstation.append(user_message)
        resp = self.client.chat.completions.create(model=self.model, messages=self.converstation)
        resp_text = resp.choices[0].message.content
        chat_message = {"role": "assistant", "content": resp_text}
